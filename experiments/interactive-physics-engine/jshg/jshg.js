...
JSHG.LEARNING_MESSAGE = "Please place your palm over the dots. The learning process is running in ";
JSHG.EPSILON = 0.0001;
    ...
    try{
        compatibility.getUserMedia({video: true}, function(stream) {
            ...
            setTimeout(function() {
                ...
                console.log("Setting isRunning_ to true");
...
JSHG.showGestureCanvas_ = function() {
    console.log("Showing Gesture Canvas!");
